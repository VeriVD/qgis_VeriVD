...
<qgis version="2.4.0-Chugiak" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="Limites_nationales" label="Limites nationales"/>
      <category symbol="1" value="Limites_canton" label="Limites canton"/>
      <category symbol="2" value="Limites_district" label="Limites district"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="color" v="199,177,151,255"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0"/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="bound_validity_type"/>
  </edittypes>
  <editform></editform>
