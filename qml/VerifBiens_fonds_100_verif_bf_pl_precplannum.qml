...
<qgis version="2.4.0-Chugiak" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="precplan" symbollevels="0" type="graduatedSymbol">
    <ranges>
      <range symbol="0" lower="0.000000" upper="3.500000" label="0 - 3.5"/>
      <range symbol="1" lower="3.500000" upper="7.500000" label="3.5 - 7.5"/>
      <range symbol="2" lower="7.500000" upper="15.500000" label="7.5 - 15.5"/>
      <range symbol="3" lower="15.500000" upper="50.500000" label="15.5 - 50.5"/>
      <range symbol="4" lower="50.500000" upper="200.000000" label="50.5 - 200"/>
    </ranges>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="233,133,150,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="precplan"/>
