...
BASE_LAYER_INFOS = {
    ...
    "Base-Tous_les_topics": (
        ...
        LayerInfo(display_name='OD surfacique', layer_name='003_ITF_OD_Element_surfacique'),
        LayerInfo(display_name='Point particulier OD', layer_name='003_ITF_OD_Point_particulier'),
        LayerInfo(display_name='Point de départ des tronçons', layer_name='009_itf_bat_point_depart', visibility=False),
        LayerInfo(display_name='Entrée de bâtiment', layer_name='009_itf_bat_entree_batiment', visibility=False),
        LayerInfo(display_name='Tronçon de rue', layer_name='009_itf_bat_troncon_rue', visibility=False),
        LayerInfo(display_name='Lieu dénommé', layer_name='009_itf_bat_lieu_denomme', visibility=False),
        LayerInfo(display_name='CO Conduite', layer_name='007_itf_co_element_conduite'),
