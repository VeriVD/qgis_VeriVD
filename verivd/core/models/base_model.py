...
class BaseLayerModel(LayerListModel):
    def __init__(self, iface: QgisInterface):
        layers = (
            VeriLayer("Base-Tous_les_topics", "Base - Tous les topics"),
            VeriLayer("Base-Points_fixes", "Base - Points fixes"),
            VeriLayer("Base-Couverture_du_sol", "Base - Couverture du sol"),
            VeriLayer("Base-Objets_divers", "Base - Objets divers"),
            VeriLayer("Base-Altimetrie", "Base - Altimétrie"),
            VeriLayer("Base-Nomenclature", "Base - Nomenclature"),
            VeriLayer("Base-Biens_fonds", "Base - Biens fonds"),
            VeriLayer("Base-Conduite", "Base - Conduite"),
            VeriLayer("Base-Limites_territoriales", "Base - Limites territoriales"),
            VeriLayer("Base-Adresses_des_batiments", "Base - Adresses des bâtiments"),
            VeriLayer("Base-Repartition_des_plans", "Base - Répartition des plans"),
        )
