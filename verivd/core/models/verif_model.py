...
VERIF_LAYER_INFOS = {
    ...
    "VerifBiens_fonds": [
        ...
        LayerInfo(
            display_name="Point limite à coté d'une limite",
            layer_name="100_VERIF_BF_PL_proche_limite",
            control_layer=True,
        ),
        LayerInfo(
    ...
    "VerifAdresses": [
        ...
        LayerInfo(
            display_name="Attribut Numero_localisation absent dans le RCBat",
    ...
    "VerifCouverture_du_sol": [
        ...
        LayerInfo(
            display_name="Genre ou designation incorrect selon DMAV (ligne)",
            sql_request='"Topic" = "CS"',
            layer_name="134_CheckPrepDMAV_OD_CS_Ligne",
            symbology_type=SymbologyType.RANDOM_CATEGORIZED,
            category_field="genre",
            symbology_data_defined_properties={QgsSymbolLayer.PropertyStrokeWidth: QgsProperty.fromValue(1)},
            opacity=1,
            control_layer=True,
        ),
        LayerInfo(
            display_name="Genre ou designation incorrect selon DMAV (surface)",
            sql_request='"Topic" = "CS"',
            layer_name="134_CheckPrepDMAV_OD_CS_Surface",
            symbology_type=SymbologyType.RANDOM_CATEGORIZED,
            category_field="genre",
            symbology_data_defined_properties={QgsSymbolLayer.PropertyStrokeWidth: QgsProperty.fromValue(1)},
            opacity=1,
