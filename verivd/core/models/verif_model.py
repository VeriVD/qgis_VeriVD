...
VERIF_LAYER_INFOS = {
    ...
    "VerifAdresses": [
        ...
        LayerInfo(
            ...
            symbology_data_defined_properties={
                QgsSymbolLayer.Property.PropertyStrokeWidth: QgsProperty.fromValue(3),
                QgsSymbolLayer.Property.PropertyCapStyle: QgsProperty.fromValue(Qt.PenCapStyle.RoundCap),
                QgsSymbolLayer.Property.PropertyJoinStyle: QgsProperty.fromValue(Qt.PenJoinStyle.RoundJoin),
            },
            control_layer=True,
        ),
        LayerInfo(
    ...
    "VerifObjets_divers": [
        ...
        LayerInfo(
            ...
            symbology_data_defined_properties={QgsSymbolLayer.Property.PropertySize: QgsProperty.fromValue(2)},
            control_layer=True,
        ),
        LayerInfo(
        ...
        LayerInfo(
            ...
            symbology_data_defined_properties={QgsSymbolLayer.Property.PropertyStrokeWidth: QgsProperty.fromValue(3)},
            opacity=0.5,
            control_layer=True,
        ),
        LayerInfo(
            ...
            symbology_type=SymbologyType.RANDOM_CATEGORIZED,
            category_field="fid_od",
            symbology_data_defined_properties={QgsSymbolLayer.Property.PropertyStrokeWidth: QgsProperty.fromValue(0.5)},
            opacity=0.5,
            control_layer=True,
        ),
        LayerInfo(display_name="Périmètre du lot", layer_name="112_itf_mise_a_jourrp"),
    ...
    "VerifGeometrie": [
        ...
        LayerInfo(
            ...
            symbology_type=SymbologyType.RANDOM_CATEGORIZED,
            category_field="nomtable",
            symbology_data_defined_properties={QgsSymbolLayer.Property.PropertyWidth: QgsProperty.fromValue(2)},
            opacity=0.5,
            visibility=False,
            control_layer=True,
        ),
