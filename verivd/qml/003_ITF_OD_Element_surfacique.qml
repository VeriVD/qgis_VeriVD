...
<qgis version="2.8.2-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="regbl_egid">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 attr="vd_genre" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="batiment_souterrain" label="batiment_souterrain"/>
      <category render="true" symbol="1" value="couvert_independant" label="couvert_independant"/>
      <category render="true" symbol="2" value="eau_canalisee_souterraine" label="eau_canalisee_souterraine"/>
      <category render="true" symbol="3" value="fontaine" label="fontaine"/>
      <category render="true" symbol="4" value="pont_passerelle" label="pont_passerelle"/>
      <category render="true" symbol="5" value="silo_tour_gazometre" label="silo_tour_gazometre"/>
      <category render="true" symbol="6" value="tunnel_passage_inferieur_galerie" label="tunnel_passage_inferieur_galerie"/>
      <category render="true" symbol="7" value="autre.piscine" label="Piscine"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="fill" name="0">
        ...
        <layer pass="0" class="SimpleFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="227,108,9,255"/>
      ...
      <symbol alpha="1" type="fill" name="2">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="217,244,255,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="3">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="178,230,255,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="4">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="216,216,216,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="152,219,150,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="vd_genre"/>
