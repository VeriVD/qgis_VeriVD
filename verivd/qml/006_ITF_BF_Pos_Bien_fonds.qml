...
<qgis minScale="1e+08" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyMaxScale="1" simplifyDrawingHints="0" maxScale="0" simplifyAlgorithm="0" labelsEnabled="1" simplifyDrawingTol="1" version="3.10.5-A Coruña" hasScaleBasedVisibilityFlag="0" readOnly="0">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" previewBkgrdColor="255,255,255,255" blendMode="0" fontItalic="0" multilineHeight="1" fontCapitals="0" textOpacity="1" fieldName="number" namedStyle="Bold" textColor="0,0,0,255" fontFamily="Cadastra" fontSizeUnit="Point" useSubstitutions="0" isExpression="0" fontUnderline="0" fontStrikeout="0" fontWeight="75" textOrientation="horizontal" fontSize="12.5" fontWordSpacing="0" fontKerning="1" fontLetterSpacing="0">
      ...
      <placement overrunDistance="0" geometryGeneratorType="PointGeometry" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceUnit="MM" layerType="PointGeometry" maxCurvedCharAngleOut="-20" priority="5" preserveRotation="1" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" placementFlags="0" centroidWhole="0" maxCurvedCharAngleIn="20" geometryGeneratorEnabled="0" xOffset="0" repeatDistance="0" placement="1" quadOffset="4" repeatDistanceUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" centroidInside="0" offsetType="0" yOffset="0" offsetUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0"/>
      <rendering scaleMin="1" displayAll="0" obstacleFactor="1" labelPerPart="0" obstacleType="0" drawLabels="1" obstacle="1" maxNumLabels="2000" fontLimitPixelSize="0" zIndex="0" fontMaxPixelSize="10000" upsidedownLabels="0" scaleMax="5000" limitNumLabels="0" scaleVisibility="1" fontMinPixelSize="3" mergeLines="0" minFeatureSize="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties" type="Map">
            <Option name="LabelRotation" type="Map">
              ...
              <Option value="360 - ((90 - (ORI * 9 / 10)))" name="expression" type="QString"/>
  ...
  <aliases>
    ...
    <alias field="posnumber_of" index="2" name=""/>
    <alias field="identdn" index="3" name=""/>
    <alias field="number" index="4" name=""/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="posnumber_of" expression=""/>
    <default applyOnUpdate="0" field="identdn" expression=""/>
    <default applyOnUpdate="0" field="number" expression=""/>
    <default applyOnUpdate="0" field="ori" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0" field="posnumber_of"/>
    <constraint constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0" field="identdn"/>
    <constraint constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0" field="number"/>
    <constraint constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0" field="ori"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="posnumber_of" exp="" desc=""/>
    <constraint field="identdn" exp="" desc=""/>
    <constraint field="number" exp="" desc=""/>
    <constraint field="ori" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column name="posnumber_of" width="-1" hidden="0" type="field"/>
      <column name="identdn" width="-1" hidden="0" type="field"/>
      <column name="number" width="-1" hidden="0" type="field"/>
      <column name="ori" width="-1" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="posnumber_of"/>
