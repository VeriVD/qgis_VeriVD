...
<qgis hasScaleBasedVisibilityFlag="1" minScale="2501" labelsEnabled="1" styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" version="3.4.4-Madeira" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingHints="0">
  ...
  <labeling type="simple">
    <settings>
      <text-style useSubstitutions="0" fontWeight="50" namedStyle="Regular Condensed" fontSizeUnit="Point" blendMode="0" fontSize="12.5" fontStrikeout="0" textColor="0,85,255,255" fontWordSpacing="0" fontCapitals="0" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fieldName=" concat ('(',number,')')" previewBkgrdColor="#000000" multilineHeight="1" fontItalic="0" isExpression="1" fontFamily="Cadastra" textOpacity="1" fontLetterSpacing="0">
      ...
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" xOffset="0" quadOffset="4" preserveRotation="1" repeatDistance="0" fitInPolygonOnly="0" centroidWhole="0" offsetType="0" maxCurvedCharAngleOut="-20" yOffset="0" dist="0" placement="0" distUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placementFlags="0" repeatDistanceUnits="MM" offsetUnits="MapUnit" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="20" priority="5" rotationAngle="0" centroidInside="0"/>
