...
<qgis maxScale="0" simplifyMaxScale="1" labelsEnabled="0" version="3.8.2-Zanzibar" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+08" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1">
    ...
    <symbols>
      <symbol clip_to_extent="1" name="0" force_rhr="0" alpha="1" type="line">
        <layer class="SimpleLine" locked="0" pass="0" enabled="1">
          ...
          <prop v="204,255,1,255" k="line_color"/>
  ...
  <DiagramLayerSettings dist="0" showAll="1" placement="2" linePlacementFlags="18" zIndex="0" obstacle="0" priority="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="troncon_rue_de" index="4" name=""/>
    <alias field="point_depart" index="5" name=""/>
    <alias field="ordre" index="6" name=""/>
    <alias field="est_axe" index="7" name=""/>
    <alias field="ufid" index="8" name=""/>
    <alias field="observation" index="9" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default field="troncon_rue_de" applyOnUpdate="0" expression=""/>
    <default field="point_depart" applyOnUpdate="0" expression=""/>
    <default field="ordre" applyOnUpdate="0" expression=""/>
    <default field="est_axe" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="troncon_rue_de" constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint field="point_depart" constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint field="ordre" constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0"/>
    <constraint field="est_axe" constraints="0" notnull_strength="0" unique_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="troncon_rue_de" desc="" exp=""/>
    <constraint field="point_depart" desc="" exp=""/>
    <constraint field="ordre" desc="" exp=""/>
    <constraint field="est_axe" desc="" exp=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="troncon_rue_de" width="-1" hidden="0" type="field"/>
      <column name="point_depart" width="-1" hidden="0" type="field"/>
      <column name="ordre" width="-1" hidden="0" type="field"/>
      <column name="est_axe" width="-1" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="est_axe"/>
    <field editable="1" name="genre"/>
    <field editable="1" name="localisation_xtf_id"/>
    <field editable="1" name="observation"/>
    <field editable="1" name="ordre"/>
    <field editable="1" name="point_depart"/>
    <field editable="1" name="troncon_rue_de"/>
