...
<qgis simplifyDrawingHints="1" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" simplifyAlgorithm="0" maxScale="0" version="3.8.2-Zanzibar" labelsEnabled="0" simplifyMaxScale="1" minScale="1e+08">
  ...
  <renderer-v2 attr="vd_genre" type="categorizedSymbol" forceraster="0" enableorderby="0" symbollevels="0">
    <categories>
      <category label="batiment_souterrain" symbol="0" value="batiment_souterrain" render="true"/>
    </categories>
    <symbols>
      <symbol name="0" force_rhr="0" clip_to_extent="1" type="fill" alpha="1">
        ...
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          ...
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="227,108,9,255" k="outline_color"/>
    ...
    <source-symbol>
      <symbol name="0" force_rhr="0" clip_to_extent="1" type="fill" alpha="1">
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="152,219,150,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
  ...
  <aliases>
    ...
    <alias name="" index="2" field="validity"/>
    <alias name="" index="3" field="type"/>
    <alias name="" index="4" field="quality"/>
    <alias name="" index="5" field="regbl_egid"/>
    <alias name="" index="6" field="vd_genre"/>
    <alias name="" index="7" field="vd_nom"/>
    <alias name="" index="8" field="vd_numero"/>
    <alias name="" index="9" field="ori"/>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="validity"/>
    <default expression="" applyOnUpdate="0" field="type"/>
    <default expression="" applyOnUpdate="0" field="quality"/>
    <default expression="" applyOnUpdate="0" field="regbl_egid"/>
    <default expression="" applyOnUpdate="0" field="vd_genre"/>
    <default expression="" applyOnUpdate="0" field="vd_nom"/>
    <default expression="" applyOnUpdate="0" field="vd_numero"/>
    <default expression="" applyOnUpdate="0" field="ori"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="validity" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="type" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="quality" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="regbl_egid" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="vd_genre" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="vd_nom" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="vd_numero" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="ori" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="regbl_egid"/>
    <constraint exp="" desc="" field="vd_genre"/>
    <constraint exp="" desc="" field="vd_nom"/>
    <constraint exp="" desc="" field="vd_numero"/>
    <constraint exp="" desc="" field="ori"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column name="validity" type="field" hidden="0" width="-1"/>
      <column name="type" type="field" hidden="0" width="-1"/>
      <column name="quality" type="field" hidden="0" width="-1"/>
      <column name="regbl_egid" type="field" hidden="0" width="-1"/>
      <column name="vd_genre" type="field" hidden="0" width="-1"/>
      <column name="vd_nom" type="field" hidden="0" width="-1"/>
      <column name="vd_numero" type="field" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="regbl_egid" editable="1"/>
    <field name="type" editable="1"/>
    <field name="validity" editable="1"/>
    <field name="vd_genre" editable="1"/>
    <field name="vd_nom" editable="1"/>
    <field name="vd_numero" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="regbl_egid" labelOnTop="0"/>
    <field name="type" labelOnTop="0"/>
    <field name="validity" labelOnTop="0"/>
    <field name="vd_genre" labelOnTop="0"/>
    <field name="vd_nom" labelOnTop="0"/>
    <field name="vd_numero" labelOnTop="0"/>
