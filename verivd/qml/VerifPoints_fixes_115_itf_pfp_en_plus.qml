...
<qgis version="2.4.0-Chugiak" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="signe = 'borne'" symbol="0" label="borne"/>
      <rule filter="signe = 'cheville'" symbol="1" label="cheville"/>
      <rule filter="signe = 'pieu'" symbol="2" label="pieu"/>
      <rule filter="signe = 'croix'" symbol="3" label="croix"/>
      <rule filter="signe = 'non_materialise'" symbol="4" label="non_materialise"/>
      <rule filter="signe=''" symbol="5" label="PFA"/>
    </rules>
    <symbols>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="geomalt"/>
    <edittype labelontop="0" editable="1" name="precplan"/>
    <edittype labelontop="0" editable="1" name="fiabplan"/>
    <edittype labelontop="0" editable="1" name="precalt"/>
    <edittype labelontop="0" editable="1" name="fiabalt"/>
    <edittype labelontop="0" editable="1" name="signe"/>
    <edittype labelontop="0" editable="1" name="fiche"/>
    <edittype labelontop="0" editable="1" name="mns_alt"/>
  </edittypes>
  <editform></editform>
