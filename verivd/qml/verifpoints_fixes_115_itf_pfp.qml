...
<qgis version="2.8.2-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="identdn">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 attr="precplan" symbollevels="0" type="graduatedSymbol">
    <ranges>
      <range render="true" symbol="0" lower="0.000000" upper="1.000000" label="0 - 1.0"/>
      <range render="true" symbol="1" lower="1.001000" upper="1.500000" label="1.0 - 1.5"/>
      <range render="true" symbol="2" lower="1.501000" upper="2.000000" label="1.5 - 2.0"/>
      <range render="true" symbol="3" lower="2.001000" upper="3.000000" label="2.0 - 3.0"/>
      <range render="true" symbol="4" lower="3.000000" upper="1000.000000" label="3.0 - 1000"/>
    </ranges>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/quadOffset" value="6"/>
    ...
    <property key="labeling/xOffset" value="-4"/>
